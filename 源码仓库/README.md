...
![系统整体架构图](docs/canvas/系统整体架构图.drawio.png)
...
![Agent池架构图](docs/canvas/Agent池架构图.drawio.png)
...
![抢单架构图](docs/canvas/抢单架构图.drawio.png)
...
![需求结构图](docs/canvas/需求结构图.drawio.png)

### 1.5 前端 Schema 搭建

![Schema Designer 架构图](docs/canvas/Schema Designer架构图.drawio.png)
